...
class AdministratorModel extends Model
{
    ...
    public function editUser(){
        ...
        if(I('get.action')=='edit'){
            ...
            $add_sql = "insert into {$tableQ}administrator(`account`,`password`,`nickname`,`realname`,`phone`,`status`)
                        VALUES ('{$data['account']}','{$password}','{$data['nickname']}','{$data['realname']}','{$data['phone']}',1)";
